(function() {
  ...
  function injectGlobalUI() {
    ...
    // Inject MT5 dark fintech stylesheet once - SCOPED to TS components only
    if (!document.getElementById('ts-mt5-styles')) {
      const style = document.createElement('style');
      style.id = 'ts-mt5-styles';
      style.textContent = `
        /* ========== TS COMPONENT VARIABLES (Scoped - does not affect page backgrounds) ========== */
        :root {
          --ts-bg-primary: #0a0a0a;
          --ts-bg-secondary: #0f0f0f;
          --ts-bg-tertiary: #161616;
          --ts-border-color: #1a1a1a;
          --ts-border-light: #222;
          --ts-text-primary: #e5e5e5;
          --ts-text-secondary: #a1a1a1;
          --ts-text-muted: #666;
          --ts-accent-primary: #10b981;
          --ts-accent-secondary: #06b6d4;
        ...
        .ts-loading-track-bar {
          width: 40%;
          height: 100%;
          background: linear-gradient(90deg, #10b981, #06b6d4);
          border-radius: 2px;
          animation: tsLoadSlide 1.2s ease-in-out infinite;
        }
        ...
        .ts-context-menu-item.ts-danger {
          color: #ef4444;
        }
        .ts-context-menu-item.ts-danger:hover {
        ...
        .ts-notif-banner-icon {
          width: 20px;
          height: 20px;
          flex-shrink: 0;
        }
        .ts-notif-banner-text {
          font-size: 12px;
          color: #e5e5e5;
          font-weight: 500;
          white-space: nowrap;
